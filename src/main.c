...
FUNCTION_DECL_FOR_YD(2022, ten);
FUNCTION_DECL_FOR_YD(2022, eleven);
FUNCTION_DECL_FOR_YD(2022, fifteen);
FUNCTION_DECL_FOR_YD(2022, nineteen);

// 2023
FUNCTION_DECL_FOR_YD(2023, one);
FUNCTION_DECL_FOR_YD(2023, two);
FUNCTION_DECL_FOR_YD(2023, three);
FUNCTION_DECL_FOR_YD(2023, four);
FUNCTION_DECL_FOR_YD(2023, five);
...
static solution solutions[] = {
    ...
    SOLUTIONS_FOR_YD(2022, ten),
    SOLUTIONS_FOR_YD(2022, eleven),
    SOLUTIONS_FOR_YD(2022, fifteen),
    SOLUTIONS_FOR_YD(2022, nineteen),

    // 2023
    SOLUTIONS_FOR_YD(2023, one),
    SOLUTIONS_FOR_YD(2023, two),
    SOLUTIONS_FOR_YD(2023, three),
    SOLUTIONS_FOR_YD(2023, four),
    SOLUTIONS_FOR_YD(2023, five),
};
